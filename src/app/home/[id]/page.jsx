                ...
                <div className='max-w-186 space-y-6'>
                    ...
                    <div className='p-6 bg-white rounded-xl shadow-md border border-[#d6d5d5]'>
                        ...
                        <div className='flex flex-wrap justify-between my-4' >
                            ...
                            <div className='flex flex-col justify-center items-center border py-4 px-20 shadow-md rounded-xl bg-base-200  border-[#d6d5d5] cursor-pointer hover:shadow-2xl '>
